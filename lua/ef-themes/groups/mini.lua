...
function M.get(c, opts)
  ...
  return vim.tbl_deep_extend("keep", picker, {
    ...
    MiniHipatternsFixme           = { fg        = c.fg_main,    bg      = c.bg_err, bold                 = true },
    MiniHipatternsHack            = { fg        = c.fg_main,    bg      = c.bg_warning, bold             = true },
    MiniHipatternsNote            = { fg        = c.fg_main,    bg      = c.bg_blue_intense, bold        = true },
    MiniHipatternsTodo            = { fg        = c.fg_main,    bg      = c.bg_info, bold                = true },
    ...
    MiniPickBorderText            = { fg        = c.fg_prompt, bg             = c.bg_dim, bold                 = true },
    ...
    MiniStarterQuery              = { fg        = c.fg_prompt },
    MiniStarterSection            = { fg        = c.fg_main, bold          = true },

    MiniStatuslineDevinfo         = { fg        = c.fg_mode_line_active, bg       = c.bg_mode_line_active },
    MiniStatuslineFileinfo        = { fg        = c.fg_mode_line_active, bg       = c.bg_mode_line_active },
    MiniStatuslineFilename        = { fg        = c.fg_mode_line_active, bg       = c.bg_dim },
    ...
    MiniTablineModifiedHidden     = { bg        = c.bg_mode_line_active, fg       = c.bg_err },
